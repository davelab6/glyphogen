...
VECTOR_LOSS_WEIGHT_COORD = 0.002
CONTOUR_COUNT_WEIGHT = 3.0
NODE_COUNT_WEIGHT = 0.005 # This helps training a *lot* - but does it cause a command loss plateau?
...
LEARNING_RATE = 4e-4 * (256 / BATCH_SIZE)
